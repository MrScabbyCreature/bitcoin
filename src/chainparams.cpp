...
{
    const char* pszTimestamp = "This is Abhor coin!";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1555509078, 325561, 0x3db19ce8, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // assert(consensus.hashGenesisBlock == uint256S("0x3d543a0654dc0e12f7e8661f010687979221e1e894c9218b2f0ab727bc2ef942"));
        // assert(genesis.hashMerkleRoot == uint256S("0x0420d111c062ad7076f51d0490c19baa3906984f1d447ad69f9ca82812c6031e"));
